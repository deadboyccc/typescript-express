...
})({"2A4bs":[function(require,module,exports,__globalThis) {
        ...
        if (value && !path && typeof value === 'object') {
            if ((0, _utilsJsDefault.default).endsWith(key, '{}')) {
                ...
                arr.forEach(function each(el, index) {
                    !((0, _utilsJsDefault.default).isUndefined(el) || el === null) && formData.append( 
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2A4bs"], "2A4bs", "parcelRequire94c2")
